...
import { useDeleteWebhook } from '@/hooks/use-load-tests';
import type { Webhook } from '@/types/load-test.types';
        ...
        <div className="flex flex-col items-center justify-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground max-w-md">
              Add web requests to your collection. Each request will be executed in the specified
              order during the test.
            </p>
          </div>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      {webhook.order !== null && webhook.order !== undefined && (
                    ...
                    {(webhook.headers || webhook.query_params || webhook.body_template) && (
                      <div className="mt-3 space-y-1 text-xs text-muted-foreground">
                        ...
                        {webhook.query_params && Object.keys(webhook.query_params).length > 0 && (
                          <div>
                            Query params: {Object.keys(webhook.query_params).length} param(s)
                          </div>
                        )}
