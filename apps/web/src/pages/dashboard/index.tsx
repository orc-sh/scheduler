  ...
  const handleCreateUrl = async () => {
    if (!firstProject) {
      toast({
        ...
        description: 'Please create a project first before creating URLs.',
        variant: 'destructive',
      });
      return;
    }
    ...
    try {
      await createUrl.mutateAsync({ project_id: firstProject.id });
    } catch (error) {
      ...
      <div className="container mx-auto max-w-6xl">
        <FadeIn>
          ...
          <div className="mb-8 flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold tracking-tight">URLs</h1>
